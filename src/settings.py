...
# Parameter names
CURRENCY_PARAMETER_NAME = 'currency'
PERIOD_PARAMETER_NAME = 'period'
DATE_PARAMETER_NAME = 'date'

DATE_FORMAT = '%Y-%m-%d'
URL_TEMPLATE = 'https://cdn.jsdelivr.net/gh/fawazahmed0/currency-api@1/{date}/currencies/{from_currency}.json'
